      ...
      sidebar: [
        {
          ...
          items: [
            ...
            { label: 'Full-Stack Foundation', slug: 'foundation/fullstack-foundation' },
          ],
        },
        {
          label: 'Product',
        ...
        },
        {
          label: 'Workflow',
          items: [
            { label: 'Development Workflow', slug: 'workflow/development-workflow' },
            { label: 'Package Management', slug: 'workflow/package-management' },
          ],
        },
        {
          label: 'ADRs',
